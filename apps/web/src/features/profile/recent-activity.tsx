...
export const RecentActivity = () => {
	return (
		<div className="rounded-2xl border-2 border-border bg-card p-6 shadow-lg">
			<h3 className="mb-4 font-bold text-xl">Recent Activity</h3>
			<div className="space-y-4">
				{recentActivity.map((activity, index) => (
					<div
						key={index}
						className="flex items-center space-x-4 rounded-lg border border-border bg-background p-3"
					>
