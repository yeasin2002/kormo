  ...
  return (
    <div className="flex w-full flex-col items-center justify-center gap-2">
      ...
      <div className="flex items-center justify-center gap-6 self-stretch border-[rgba(55,50,47,0.12)] border-b px-6 py-12 md:px-24 md:py-16">
        <div className="flex w-full max-w-[586px] flex-col items-center justify-start gap-4 overflow-hidden rounded-lg px-6 py-5 shadow-none">
          {/* Pricing Badge */}
      ...
      <div className="flex items-center justify-center self-stretch border-[rgba(55,50,47,0.12)] border-t border-b">
        <div className="flex w-full items-start justify-center">
          ...
          <div className="flex flex-1 flex-col items-center justify-center gap-6 py-12 md:flex-row md:py-0">
            {/* Starter Plan */}
            <div className="flex max-w-full flex-1 flex-col items-start justify-start gap-12 self-stretch overflow-hidden border border-[#E0DEDB]  bg-[rgba(255,255,255,0)] px-6 py-5 md:max-w-none">
              {/* Plan Header */}
            ...
            <div className="flex max-w-full flex-1 flex-col items-start justify-start gap-12 self-stretch overflow-hidden border  border-[rgba(55,50,47,0.12)] bg-[#37322F] px-6 py-5 md:max-w-none">
              {/* Plan Header */}
              <div className="flex flex-col items-center justify-start gap-9 self-stretch">
                <div className="flex flex-col items-start justify-start gap-2 self-stretch">
