        ...
        <div className="grid flex-1 grid-cols-1 gap-0 border-[rgba(55,50,47,0.12)] border-r border-l md:grid-cols-2">
          {featureList.map((items) => {
            return (
              <div
                key={items.name}
                className="flex flex-col items-start justify-between gap-4 border-[rgba(55,50,47,0.12)] border-r-0 border-b p-4 sm:gap-6 sm:p-6 md:border-r md:p-8 lg:p-12"
              >
