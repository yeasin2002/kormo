...
const tools = [
	...
	},
	{
		...
		description:
			"This tool helps you extract text from images, making it easier to work with text data.",
	},
];
	...
	return (
		<section className="mb-16">
			...
			<div className="mt-7 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
				...
				<div className="flex size-full items-center justify-center rounded-lg border border-gray-700 bg-card p-6 text-foreground shadow-lg">
					<p className="font-sans text-muted-foreground text-xl">
						Coming More!
					</p>
				</div>
			</div>
