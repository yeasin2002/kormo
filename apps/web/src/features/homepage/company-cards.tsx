...
export function CompanyCard({ company }: CompanyCardProps) {
  return (
    <div className="group rounded-lg border border-gray-700 bg-[#FED1AC] p-6 font-sans text-[#1E1E1E] shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-xl dark:bg-gray-900">
      {/* Company Header */}
      <div className="mb-6">
        <h3 className="font-head mb-2 text-xl font-bold transition-colors">
          {company['CompanyName']}
        </h3>
      ...
      <div className="mb-6">
        ...
        <div className="flex flex-wrap gap-2">
          {company.Technologies.map((tech, index) => (
            <Badge
              key={index}
              className="border-gray-600 bg-gray-800 text-xs text-gray-100 hover:bg-gray-700"
            >
              {tech}
            </Badge>
          ))}
