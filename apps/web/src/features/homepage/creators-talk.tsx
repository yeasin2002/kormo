				...
				<div className="flex w-full justify-center lg:justify-start">
					<div className="relative">
						<img
							...
							className="h-64 w-64 rounded-2xl border-4 border-border object-cover shadow-lg lg:h-80 lg:w-80"
						/>
					</div>
				</div>

				<div>
					<div className="font-bold text-6xl text-primary leading-none">“</div>
					<blockquote className="font-bold text-2xl text-foreground leading-tight lg:text-3xl">
