...
export const FileUploader = ({
	...
	return (
		<div>
			<Label htmlFor="file-upload" className="mb-2 block font-bold text-lg">
				{label}
			</Label>
			<div
				className="rounded-xl border-2 border-border border-dashed bg-background p-8 text-center"
					...
					{file ? (
						...
						<>
							...
							<p className="text-muted-foreground">
								or{" "}
								<span className="font-bold text-purple-500">browse files</span>{" "}
