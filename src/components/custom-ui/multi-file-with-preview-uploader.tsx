...
import { FileUploadActions, FileUploadState, formatBytes } from '@/hooks/use-file-upload';
...
export function MultiMediaUploaderWithPreview({ state, actions, maxSizeMB, maxFiles }: Props) {
